        ...
        for(int i=0; i<queries; i++){
            ...
            if(!que.empty()){
                ...
                if(i-cur.second+1>blockTime){
                    que.pop();
                    if(word1[cur.first]!=word2[cur.first]) differences++;
                }
            }
            if(cmd==1){
                int index;
                cin>>index;
                index--;
                if(word1[index]!=word2[index]) differences--;
            ...
            if(cmd==2){
                ...
                if(word1[firstPos]!=word2[firstPos]) differences--;
                if(word1[secondPos]!=word2[secondPos]) differences--;
